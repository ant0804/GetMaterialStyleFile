        ...
        this.each(function() {
            ...
            function r(t) {
                ...
                n = p.setTimeout(function() {
                    u.find(":focus").blur(),
                    true === s.instantlyCloseOthers && u.removeClass("show"),
                    p.clearTimeout(n),
            ...
            i.hover(function(t) {
                if (!i.hasClass("show") && !e.is(t.target))
                    return true;
                767 < c(p).width() && r(t)
            }, function() {
                767 < c(p).width() && (p.clearTimeout(n),
            ...
            e.hover(function(t) {
                if (!i.hasClass("show") && !i.is(t.target) && 767 < c(p).width())
                    return true;
                767 < c(p).width() && r(t)
            }),
...
function(a) {
    ...
    function o(t) {
        var i = false;
        (t.is(a.material.options.checkboxElements) || t.is(a.material.options.radioElements)) && (i = true),
        t.closest("label").hover(function() {
            var t, o, n = a(this).find("input"), e = n.prop("disabled");
            i && (t = a(this),
            o = e,
    ...
    a.material = {
        ...
        checkbox: function(t) {
            o(a(t || this.options.checkboxElements).filter(":notmdproc").data("mdproc", true).after("<span class='checkbox-material'><span class='check'></span></span>"))
        },
        togglebutton: function(t) {
            o(a(t || this.options.togglebuttonElements).filter(":notmdproc").data("mdproc", true).after("<span class='toggle'></span>"))
        },
        radio: function(t) {
            o(a(t || this.options.radioElements).filter(":notmdproc").data("mdproc", true).after("<span class='circle'></span><span class='check'></span>"))
        },
        input: function(t) {
            a(t || this.options.inputElements).filter(":notmdproc").data("mdproc", true).each(function() {
                var n = a(this)
...
function tabs() {
    for (var t = $(".nav.nav-tabs"), i = {}, a = {}, o = 0; o < t.length; o++) {
        ...
        $(s[s.length - 1]).hasClass("ms-tabs-indicator") || ($(t[o]).data("id", n),
        ...
        for (m = 0; m < e; m++)
            c[m] = p,
            l[m] = $(s[m]).width(),
            $(s[m]).children().hasClass("active") && r.css({
                left: c[m] + "px",
                width: l[m] + "px"
            }),
            p += l[m]
    ...
    $(".nav.nav-tabs > li").click(function(t) {
        ...
        s.children().removeClass("current"),
        $(this).addClass("current");
        for (var n = s.children(), e = 0; e < n.length - 1; e++)
            $(n[e]).hasClass("current") && $("#i" + o).css({
                left: a["tabL" + o][e] + "px",
                width: i["tabW" + o][e] + "px"
            })
    })
