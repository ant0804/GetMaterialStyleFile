function widthOptions() {
    ...
    $.cookie("ms-width")) {
        var o = $.cookie("ms-width");
        e(o),
        $("#" + o + "Width").prop("checked", !0)
    }
    function e(o) {
...
function headerOptions() {
    var a = "primary"
      ...
      , r = $(".ms-navbar");
    function s(o, e) {
        r.removeClass("navbar-mode"),
        "hidden" == o ? n.removeClass("d-none") : n.removeClass("ms-header-" + o),
        "hidden" == e ? (n.addClass("d-none"),
        $("#noHeader").prop("checked", !0),
        r.addClass("navbar-mode")) : (n.addClass("ms-header-" + e),
    ...
    function c(o, e) {
        r.removeClass("ms-navbar-" + o),
        r.addClass("ms-navbar-" + e),
        i = e,
    ...
    $.cookie("ms-header-color") && (o = $.cookie("ms-header-color")),
    $.cookie("ms-navbar-color") && (e = $.cookie("ms-navbar-color")),
    s(a, o),
    c(i, e),
...
function ColorOptions() {
    var a = urlofdoc("app.min.js") + "css/"
      ...
      , e = 500;
    function s(o, e) {
        i.attr("href", a + "style." + o + "-" + e + ".min.css"),
    ...
    $.cookie("ms-color") && ($(".grad").removeClass(o),
    o = $.cookie("ms-color"),
    $.cookie("ms-shine") && (e = $.cookie("ms-shine")),
    s(o, e),
    $(".grad").addClass(o)),
    $("#color-options .ms-color-box-primary").click(function() {
        return $(".grad").removeClass(o),
        o = $(this).data("color"),
        $(".grad").addClass(o),
        s(o, 500),
        !1
...
function urlofdoc(o) {
    var e, a;
    return 0 <= (e = $("script[src*='app.min.js']").attr("src")).indexOf(o) && (a = e.substring(0, e.indexOf(o) - 3)),
    a
}
